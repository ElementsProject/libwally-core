...
WALLY_FN_P3_A(tx_clone, wally_tx_clone)
...
WALLY_FN_PP(psbt_input_set_non_witness_utxo, wally_psbt_input_set_non_witness_utxo)
WALLY_FN_PP(psbt_input_set_partial_sigs, wally_psbt_input_set_partial_sigs)
...
WALLY_FN_PB(psbt_input_set_asset_blinder, wally_psbt_input_set_asset_blinder)
WALLY_FN_PB(psbt_input_set_claim_script, wally_psbt_input_set_claim_script)
WALLY_FN_PB(psbt_input_set_genesis_hash, wally_psbt_input_set_genesis_hash)
WALLY_FN_PB(psbt_input_set_txout_proof, wally_psbt_input_set_txout_proof)
WALLY_FN_PB(psbt_input_set_value_blinder, wally_psbt_input_set_value_blinder)
WALLY_FN_PB(psbt_output_set_asset_blinder, wally_psbt_output_set_asset_blinder)
...
WALLY_FN_PB(psbt_output_set_nonce_commitment, wally_psbt_output_set_nonce_commitment)
WALLY_FN_PB(psbt_output_set_range_proof, wally_psbt_output_set_range_proof)
WALLY_FN_PB(psbt_output_set_surjection_proof, wally_psbt_output_set_surjection_proof)
WALLY_FN_PB(psbt_output_set_value_blinder, wally_psbt_output_set_value_blinder)
...
WALLY_FN_PP(psbt_input_set_peg_in_tx, wally_psbt_input_set_peg_in_tx)
