...
WALLY_CORE_API int wally_psbt_get_input_pegin_txoutproof(const struct wally_psbt *psbt, size_t index, unsigned char *bytes_out, size_t len, size_t *written);
WALLY_CORE_API int wally_psbt_get_input_pegin_txoutproof_len(const struct wally_psbt *psbt, size_t index, size_t *written);
...
WALLY_CORE_API int wally_psbt_set_input_inflation_keys_rangeproof(struct wally_psbt *psbt, size_t index,
...
WALLY_CORE_API int wally_psbt_set_input_pegin_txoutproof(struct wally_psbt *psbt, size_t index, const unsigned char *proof, size_t proof_len);
