...
class PSBTTests(unittest.TestCase):
    ...
    def test_psbt(self):
        ...
        for p in [psbt, psbt2]:
            ...
            for taproot_sig in [dummy_sig_tap_default, dummy_sig_tap_all, dummy_sig_tap_single]:
                psbt_set_input_taproot_signature(p, 0, taproot_sig)
                self.assertEqual(psbt_get_input_taproot_signature(p, 0), taproot_sig)
