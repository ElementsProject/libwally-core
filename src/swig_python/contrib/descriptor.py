...
class DescriptorTests(unittest.TestCase):
    ...
    def test_descriptor_to_addresses(self):
        ...
        descriptor = descriptor_parse(descriptor_str, None, WALLY_NETWORK_BITCOIN_MAINNET, flags)
        addrs = descriptor_to_addresses(descriptor, 0, child_num, 0, len(expected))
