...
%pybuffer_nullable_binary(const unsigned char* extra_input32, size_t extra_len);
...
%pybuffer_nullable_binary(const unsigned char* msg32, size_t msg_len);
...
%pybuffer_nullable_binary(const unsigned char* pubkey, size_t pubkey_len);
%pybuffer_nullable_binary(const unsigned char* pubkey33, size_t pubkey33_len);
%pybuffer_nullable_binary(const unsigned char* pubkey33, size_t pubkey_len);
