...
export const BIP39_ENTROPY_MAX_LEN = (BIP39_ENTROPY_LEN_320 + 2);
...
export const LIBWALLY_CORE_BIP32_INT_H = 1;
export const LIBWALLY_CORE_PSBT_MEMBERS_H = 1;
export const LIBWALLY_CORE_SCRIPT_INT_H = 1;
export const LIBWALLY_CORE_TRANSACTION_INT_H = 1;
...
export const WALLY_SEGWIT_ADDRESS_PUBKEY_MAX_LEN = 34;
