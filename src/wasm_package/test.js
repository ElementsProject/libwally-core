...
assert.equal(bytesToHex(Wally.wally_tx_get_txid(tx1)), "bc54928ad07bbe606ec27c8f9af9266b5c73cf01219f5cc545f849135c44bc90")

// Test bigint return value
assert.equal(Wally.wally_tx_get_total_output_satoshi(tx1), 1006222n)
Wally.wally_tx_free(tx1)

// Test bigint argument
assert.equal(Wally.wally_varint_get_length(100000n), 5)
