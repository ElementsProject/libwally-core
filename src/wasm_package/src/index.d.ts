...
export function descriptor_to_scriptpubkey_len(descriptor: string, vars_in: Ref_wally_map, child_num: number, network: number, depth: number, index: number, flags: number): number;
...
export function descriptor_to_scriptpubkey(descriptor: string, vars_in: Ref_wally_map, child_num: number, network: number, depth: number, index: number, flags: number): Buffer;
