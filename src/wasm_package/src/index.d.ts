...
export function tx_get_elements_taproot_signature_hash(tx: Ref_wally_tx, index: number, scripts: Ref_wally_map, assets: Ref_wally_map, values: Ref_wally_map, tapleaf_script: Buffer|Uint8Array, key_version: number, codesep_position: number, annex: Buffer|Uint8Array, genesis_blockhash: Buffer|Uint8Array, sighash: number, flags: number): Buffer;
