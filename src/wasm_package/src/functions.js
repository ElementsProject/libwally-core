...
export const descriptor_canonicalize = wrap('wally_descriptor_canonicalize', [T.String, T.OpaqueRef, T.Int32, T.DestPtrPtr(T.String)]);
export const descriptor_free = wrap('wally_descriptor_free', [T.OpaqueRef]);
export const descriptor_get_checksum = wrap('wally_descriptor_get_checksum', [T.String, T.OpaqueRef, T.Int32, T.DestPtrPtr(T.String)]);
...
export const miniscript_to_script_len = wrap('wally_miniscript_to_script_len', [T.String, T.OpaqueRef, T.Int32, T.Int32, T.DestPtr(T.Int32)]);
...
export const miniscript_to_script = wrap('wally_miniscript_to_script', [T.String, T.OpaqueRef, T.Int32, T.Int32, T.DestPtrVarLen(T.Bytes, miniscript_to_script_len, false)]);
