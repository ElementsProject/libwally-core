...
export const hex_n_to_bytes = wrap('wally_hex_n_to_bytes', [T.String, T.Int32, T.DestPtrVarLen(hex_n_to_bytes_len)]);
export const hex_n_verify = wrap('wally_hex_n_verify', [T.String, T.Int32]);
export const hex_to_bytes = wrap('wally_hex_to_bytes', [T.String, T.DestPtrVarLen(hex_to_bytes_len)]);
