...
export const descriptor_create_checksum = wrap('wally_descriptor_create_checksum', [T.String, T.OpaqueRef, T.Int32, T.DestPtrPtr(T.String)]);
export const descriptor_parse_miniscript_len = wrap('wally_descriptor_parse_miniscript_len', [T.String, T.OpaqueRef, T.Int32, T.Int32, T.DestPtr(T.Int32)]);
...
export const descriptor_to_addresses = wrap('wally_descriptor_to_addresses_alloc', [T.String, T.OpaqueRef, T.Int32, T.Int32, T.Int32, T.Int32, T.DestPtrPtr(T.OpaqueRef)]);
export const descriptor_to_scriptpubkey_len = wrap('wally_descriptor_to_scriptpubkey_len', [T.String, T.OpaqueRef, T.Int32, T.Int32, T.Int32, T.Int32, T.Int32, T.DestPtr(T.Int32)]);
...
export const descriptor_parse_miniscript = wrap('wally_descriptor_parse_miniscript', [T.String, T.OpaqueRef, T.Int32, T.Int32, T.DestPtrVarLen(T.Bytes, descriptor_parse_miniscript_len, false)]);
export const descriptor_to_scriptpubkey = wrap('wally_descriptor_to_scriptpubkey', [T.String, T.OpaqueRef, T.Int32, T.Int32, T.Int32, T.Int32, T.Int32, T.DestPtrVarLen(T.Bytes, descriptor_to_scriptpubkey_len, false)]);
