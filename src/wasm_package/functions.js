...
export const addr_segwit_n_to_bytes = wrap('wally_addr_segwit_n_to_bytes', [T.String, T.Int32, T.String, T.Int32, T.Int32, T.DestPtrVarLen(C.WALLY_SEGWIT_ADDRESS_PUBKEY_MAX_LEN, true)]);
export const addr_segwit_to_bytes = wrap('wally_addr_segwit_to_bytes', [T.String, T.String, T.Int32, T.DestPtrVarLen(C.WALLY_SEGWIT_ADDRESS_PUBKEY_MAX_LEN, true)]);
export const address_to_scriptpubkey = wrap('wally_address_to_scriptpubkey', [T.String, T.Int32, T.DestPtrVarLen(C.WALLY_ADDRESS_PUBKEY_MAX_LEN, true)]);
export const ae_host_commit_from_bytes = wrap('wally_ae_host_commit_from_bytes', [T.Bytes, T.Int32, T.DestPtrSized(C.WALLY_HOST_COMMITMENT_LEN)]);
...
export const asset_generator_from_bytes = wrap('wally_asset_generator_from_bytes', [T.Bytes, T.Bytes, T.DestPtrSized(C.ASSET_GENERATOR_LEN)]);
export const asset_pak_whitelistproof = wrap('wally_asset_pak_whitelistproof', [T.Bytes, T.Bytes, T.Int32, T.Bytes, T.Bytes, T.Bytes, T.DestPtrVarLen(asset_pak_whitelistproof_len, false)]);
export const asset_pak_whitelistproof_size = wrap('wally_asset_pak_whitelistproof_size', [T.Int32, T.DestPtr(T.Int32)]);
export const asset_rangeproof = wrap('wally_asset_rangeproof', [T.Int64, T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.Int64, T.Int32, T.Int32, T.DestPtrVarLen(C.ASSET_RANGEPROOF_MAX_LEN, true)]);
export const asset_rangeproof_with_nonce = wrap('wally_asset_rangeproof_with_nonce', [T.Int64, T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.Int64, T.Int32, T.Int32, T.DestPtrVarLen(C.ASSET_RANGEPROOF_MAX_LEN, true)]);
export const asset_scalar_offset = wrap('wally_asset_scalar_offset', [T.Int64, T.Bytes, T.Bytes, T.DestPtrSized(C.EC_SCALAR_LEN)]);
export const asset_surjectionproof = wrap('wally_asset_surjectionproof', [T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.DestPtrVarLen(asset_surjectionproof_len, true)]);
export const asset_surjectionproof_size = wrap('wally_asset_surjectionproof_size', [T.Int32, T.DestPtr(T.Int32)]);
export const asset_unblind = wrap('wally_asset_unblind', [T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.DestPtrSized(C.ASSET_TAG_LEN), T.DestPtrSized(C.BLINDING_FACTOR_LEN), T.DestPtrSized(C.BLINDING_FACTOR_LEN), T.DestPtr(T.Int64)]);
export const asset_unblind_with_nonce = wrap('wally_asset_unblind_with_nonce', [T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.DestPtrSized(C.ASSET_TAG_LEN), T.DestPtrSized(C.BLINDING_FACTOR_LEN), T.DestPtrSized(C.BLINDING_FACTOR_LEN), T.DestPtr(T.Int64)]);
export const asset_value_commitment = wrap('wally_asset_value_commitment', [T.Int64, T.Bytes, T.Bytes, T.DestPtrSized(C.ASSET_COMMITMENT_LEN)]);
...
export const bip32_key_get_fingerprint = wrap('bip32_key_get_fingerprint', [T.OpaqueRef, T.DestPtrSized(C.BIP32_KEY_FINGERPRINT_LEN)]);
...
export const bip32_key_serialize = wrap('bip32_key_serialize', [T.OpaqueRef, T.Int32, T.DestPtrSized(C.BIP32_SERIALIZED_LEN)]);
...
export const bip38_raw_from_private_key = wrap('bip38_raw_from_private_key', [T.Bytes, T.Bytes, T.Int32, T.DestPtrSized(C.BIP38_SERIALIZED_LEN)]);
export const bip38_raw_get_flags = wrap('bip38_raw_get_flags', [T.Bytes, T.DestPtr(T.Int32)]);
export const bip38_raw_to_private_key = wrap('bip38_raw_to_private_key', [T.Bytes, T.Bytes, T.Int32, T.DestPtrSized(C.EC_PRIVATE_KEY_LEN)]);
export const bip38_to_private_key = wrap('bip38_to_private_key', [T.String, T.Bytes, T.Int32, T.DestPtrSized(C.EC_PRIVATE_KEY_LEN)]);
...
export const bip39_mnemonic_to_bytes = wrap('bip39_mnemonic_to_bytes', [T.OpaqueRef, T.String, T.DestPtrVarLen(C.BIP39_ENTROPY_MAX_LEN, true)]);
export const bip39_mnemonic_to_seed = wrap('bip39_mnemonic_to_seed', [T.String, T.String, T.DestPtrVarLen(C.BIP39_SEED_LEN_512)]);
...
export const confidential_addr_segwit_to_ec_public_key = wrap('wally_confidential_addr_segwit_to_ec_public_key', [T.String, T.String, T.DestPtrSized(C.EC_PUBLIC_KEY_LEN)]);
...
export const confidential_addr_to_ec_public_key = wrap('wally_confidential_addr_to_ec_public_key', [T.String, T.Int32, T.DestPtrSized(C.EC_PUBLIC_KEY_LEN)]);
export const ec_private_key_verify = wrap('wally_ec_private_key_verify', [T.Bytes]);
export const ec_public_key_decompress = wrap('wally_ec_public_key_decompress', [T.Bytes, T.DestPtrSized(C.EC_PUBLIC_KEY_UNCOMPRESSED_LEN)]);
export const ec_public_key_from_private_key = wrap('wally_ec_public_key_from_private_key', [T.Bytes, T.DestPtrSized(C.EC_PUBLIC_KEY_LEN)]);
export const ec_public_key_negate = wrap('wally_ec_public_key_negate', [T.Bytes, T.DestPtrSized(C.EC_PUBLIC_KEY_LEN)]);
export const ec_public_key_verify = wrap('wally_ec_public_key_verify', [T.Bytes]);
export const ec_scalar_add = wrap('wally_ec_scalar_add', [T.Bytes, T.Bytes, T.DestPtrSized(C.EC_SCALAR_LEN)]);
export const ec_scalar_add_to = wrap('wally_ec_scalar_add_to', [T.DestPtrSized(100), T.Bytes]);
export const ec_scalar_multiply = wrap('wally_ec_scalar_multiply', [T.Bytes, T.Bytes, T.DestPtrSized(C.EC_SCALAR_LEN)]);
export const ec_scalar_multiply_by = wrap('wally_ec_scalar_multiply_by', [T.DestPtrSized(100), T.Bytes]);
export const ec_scalar_subtract = wrap('wally_ec_scalar_subtract', [T.Bytes, T.Bytes, T.DestPtrSized(C.EC_SCALAR_LEN)]);
...
export const ec_sig_from_bytes = wrap('wally_ec_sig_from_bytes', [T.Bytes, T.Bytes, T.Int32, T.DestPtrSized(ec_sig_from_bytes_len, false)]);
export const ec_sig_from_der = wrap('wally_ec_sig_from_der', [T.Bytes, T.DestPtrSized(C.EC_SIGNATURE_LEN)]);
export const ec_sig_normalize = wrap('wally_ec_sig_normalize', [T.Bytes, T.DestPtrSized(C.EC_SIGNATURE_LEN)]);
export const ec_sig_to_der = wrap('wally_ec_sig_to_der', [T.Bytes, T.DestPtrVarLen(C.EC_SIGNATURE_DER_MAX_LEN, true)]);
export const ec_sig_to_public_key = wrap('wally_ec_sig_to_public_key', [T.Bytes, T.Bytes, T.DestPtrSized(C.EC_PUBLIC_KEY_LEN)]);
...
export const ecdh = wrap('wally_ecdh', [T.Bytes, T.Bytes, T.DestPtrSized(C.SHA256_LEN)]);
export const ecdh_nonce_hash = wrap('wally_ecdh_nonce_hash', [T.Bytes, T.Bytes, T.DestPtrSized(C.SHA256_LEN)]);
export const elements_pegin_contract_script_from_bytes = wrap('wally_elements_pegin_contract_script_from_bytes', [T.Bytes, T.Bytes, T.Int32, T.DestPtrVarLen(elements_pegin_contract_script_from_bytes_len, true)]);
export const elements_pegout_script_from_bytes = wrap('wally_elements_pegout_script_from_bytes', [T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.Int32, T.DestPtrVarLen(elements_pegout_script_from_bytes_len, true)]);
...
export const explicit_rangeproof = wrap('wally_explicit_rangeproof', [T.Int64, T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.DestPtrVarLen(C.ASSET_EXPLICIT_RANGEPROOF_MAX_LEN, true)]);
export const explicit_rangeproof_verify = wrap('wally_explicit_rangeproof_verify', [T.Bytes, T.Int64, T.Bytes, T.Bytes]);
export const explicit_surjectionproof = wrap('wally_explicit_surjectionproof', [T.Bytes, T.Bytes, T.Bytes, T.DestPtrSized(C.ASSET_EXPLICIT_SURJECTIONPROOF_LEN)]);
export const explicit_surjectionproof_verify = wrap('wally_explicit_surjectionproof_verify', [T.Bytes, T.Bytes, T.Bytes]);
export const format_bitcoin_message = wrap('wally_format_bitcoin_message', [T.Bytes, T.Int32, T.DestPtrVarLen(format_bitcoin_message_len, true)]);
...
export const hash160 = wrap('wally_hash160', [T.Bytes, T.DestPtrSized(C.HASH160_LEN)]);
export const hex_from_bytes = wrap('wally_hex_from_bytes', [T.Bytes, T.DestPtrPtr(T.String)]);
export const hex_n_to_bytes = wrap('wally_hex_n_to_bytes', [T.String, T.Int32, T.DestPtrVarLen(hex_n_to_bytes_len, false)]);
export const hex_n_verify = wrap('wally_hex_n_verify', [T.String, T.Int32]);
export const hex_to_bytes = wrap('wally_hex_to_bytes', [T.String, T.DestPtrVarLen(hex_to_bytes_len, false)]);
export const hex_verify = wrap('wally_hex_verify', [T.String]);
export const hmac_sha256 = wrap('wally_hmac_sha256', [T.Bytes, T.Bytes, T.DestPtrSized(C.HMAC_SHA256_LEN)]);
export const hmac_sha512 = wrap('wally_hmac_sha512', [T.Bytes, T.Bytes, T.DestPtrSized(C.HMAC_SHA512_LEN)]);
...
export const pbkdf2_hmac_sha256 = wrap('wally_pbkdf2_hmac_sha256', [T.Bytes, T.Bytes, T.Int32, T.Int32, T.DestPtrSized(C.PBKDF2_HMAC_SHA256_LEN)]);
export const pbkdf2_hmac_sha512 = wrap('wally_pbkdf2_hmac_sha512', [T.Bytes, T.Bytes, T.Int32, T.Int32, T.DestPtrSized(C.PBKDF2_HMAC_SHA512_LEN)]);
...
export const psbt_get_id = wrap('wally_psbt_get_id', [T.OpaqueRef, T.Int32, T.DestPtrSized(C.WALLY_TXHASH_LEN)]);
...
export const ripemd160 = wrap('wally_ripemd160', [T.Bytes, T.DestPtrSized(C.RIPEMD160_LEN)]);
export const s2c_commitment_verify = wrap('wally_s2c_commitment_verify', [T.Bytes, T.Bytes, T.Bytes, T.Int32]);
export const s2c_sig_from_bytes = wrap('wally_s2c_sig_from_bytes', [T.Bytes, T.Bytes, T.Bytes, T.Int32, T.DestPtrSized(C.WALLY_S2C_OPENING_LEN), T.DestPtrSized(C.EC_SIGNATURE_LEN)]);
export const script_push_from_bytes = wrap('wally_script_push_from_bytes', [T.Bytes, T.Int32, T.DestPtrVarLen(script_push_from_bytes_len, true)]);
export const scriptpubkey_csv_2of2_then_1_from_bytes = wrap('wally_scriptpubkey_csv_2of2_then_1_from_bytes', [T.Bytes, T.Int32, T.Int32, T.DestPtrVarLen(scriptpubkey_csv_2of2_then_1_from_bytes_len, true)]);
export const scriptpubkey_csv_2of2_then_1_from_bytes_opt = wrap('wally_scriptpubkey_csv_2of2_then_1_from_bytes_opt', [T.Bytes, T.Int32, T.Int32, T.DestPtrVarLen(scriptpubkey_csv_2of2_then_1_from_bytes_opt_len, true)]);
export const scriptpubkey_csv_2of3_then_2_from_bytes = wrap('wally_scriptpubkey_csv_2of3_then_2_from_bytes', [T.Bytes, T.Int32, T.Int32, T.DestPtrVarLen(scriptpubkey_csv_2of3_then_2_from_bytes_len, true)]);
export const scriptpubkey_get_type = wrap('wally_scriptpubkey_get_type', [T.Bytes, T.DestPtr(T.Int32)]);
export const scriptpubkey_multisig_from_bytes = wrap('wally_scriptpubkey_multisig_from_bytes', [T.Bytes, T.Int32, T.Int32, T.DestPtrVarLen(scriptpubkey_multisig_from_bytes_len, true)]);
export const scriptpubkey_op_return_from_bytes = wrap('wally_scriptpubkey_op_return_from_bytes', [T.Bytes, T.Int32, T.DestPtrVarLen(C.WALLY_SCRIPTPUBKEY_OP_RETURN_MAX_LEN, true)]);
export const scriptpubkey_p2pkh_from_bytes = wrap('wally_scriptpubkey_p2pkh_from_bytes', [T.Bytes, T.Int32, T.DestPtrVarLen(C.WALLY_SCRIPTPUBKEY_P2PKH_LEN, true)]);
export const scriptpubkey_p2sh_from_bytes = wrap('wally_scriptpubkey_p2sh_from_bytes', [T.Bytes, T.Int32, T.DestPtrVarLen(C.WALLY_SCRIPTPUBKEY_P2SH_LEN, true)]);
export const scriptpubkey_to_address = wrap('wally_scriptpubkey_to_address', [T.Bytes, T.Int32, T.DestPtrPtr(T.String)]);
export const scriptsig_multisig_from_bytes = wrap('wally_scriptsig_multisig_from_bytes', [T.Bytes, T.Bytes, T.Uint32Array, T.Int32, T.DestPtrVarLen(scriptsig_multisig_from_bytes_len, true)]);
export const scriptsig_p2pkh_from_der = wrap('wally_scriptsig_p2pkh_from_der', [T.Bytes, T.Bytes, T.DestPtrVarLen(C.WALLY_SCRIPTSIG_P2PKH_MAX_LEN, true)]);
export const scriptsig_p2pkh_from_sig = wrap('wally_scriptsig_p2pkh_from_sig', [T.Bytes, T.Bytes, T.Int32, T.DestPtrVarLen(C.WALLY_SCRIPTSIG_P2PKH_MAX_LEN, true)]);
...
export const sha256_midstate = wrap('wally_sha256_midstate', [T.Bytes, T.DestPtrSized(C.SHA256_LEN)]);
export const sha256d = wrap('wally_sha256d', [T.Bytes, T.DestPtrSized(C.SHA256_LEN)]);
export const sha512 = wrap('wally_sha512', [T.Bytes, T.DestPtrSized(C.SHA512_LEN)]);
export const symmetric_key_from_parent = wrap('wally_symmetric_key_from_parent', [T.Bytes, T.Int32, T.Bytes, T.DestPtrSized(C.HMAC_SHA512_LEN)]);
export const symmetric_key_from_seed = wrap('wally_symmetric_key_from_seed', [T.Bytes, T.DestPtrSized(C.HMAC_SHA512_LEN)]);
...
export const tx_confidential_value_from_satoshi = wrap('wally_tx_confidential_value_from_satoshi', [T.Int64, T.DestPtrSized(C.WALLY_TX_ASSET_CT_VALUE_UNBLIND_LEN)]);
...
export const tx_elements_issuance_calculate_asset = wrap('wally_tx_elements_issuance_calculate_asset', [T.Bytes, T.DestPtrSized(C.SHA256_LEN)]);
export const tx_elements_issuance_calculate_reissuance_token = wrap('wally_tx_elements_issuance_calculate_reissuance_token', [T.Bytes, T.Int32, T.DestPtrSized(C.SHA256_LEN)]);
export const tx_elements_issuance_generate_entropy = wrap('wally_tx_elements_issuance_generate_entropy', [T.Bytes, T.Int32, T.Bytes, T.DestPtrSized(C.SHA256_LEN)]);
...
export const tx_get_btc_signature_hash = wrap('wally_tx_get_btc_signature_hash', [T.OpaqueRef, T.Int32, T.Bytes, T.Int64, T.Int32, T.Int32, T.DestPtrSized(C.SHA256_LEN)]);
export const tx_get_elements_signature_hash = wrap('wally_tx_get_elements_signature_hash', [T.OpaqueRef, T.Int32, T.Bytes, T.Bytes, T.Int32, T.Int32, T.DestPtrSized(C.SHA256_LEN)]);
export const tx_get_length = wrap('wally_tx_get_length', [T.OpaqueRef, T.Int32, T.DestPtr(T.Int32)]);
export const tx_get_signature_hash = wrap('wally_tx_get_signature_hash', [T.OpaqueRef, T.Int32, T.Bytes, T.Bytes, T.Int32, T.Int64, T.Int32, T.Int32, T.Int32, T.DestPtrSized(C.SHA256_LEN)]);
...
export const wif_to_bytes = wrap('wally_wif_to_bytes', [T.String, T.Int32, T.Int32, T.DestPtrSized(C.EC_PRIVATE_KEY_LEN)]);
export const wif_to_public_key = wrap('wally_wif_to_public_key', [T.String, T.Int32, T.DestPtrVarLen(wif_to_public_key_len, true)]);
...
export const witness_program_from_bytes = wrap('wally_witness_program_from_bytes', [T.Bytes, T.Int32, T.DestPtrVarLen(C.WALLY_WITNESSSCRIPT_MAX_LEN, true)]);
export const witness_program_from_bytes_and_version = wrap('wally_witness_program_from_bytes_and_version', [T.Bytes, T.Int32, T.Int32, T.DestPtrVarLen(C.WALLY_WITNESSSCRIPT_MAX_LEN, true)]);
export const base58_n_to_bytes = wrap('wally_base58_n_to_bytes', [T.String, T.Int32, T.Int32, T.DestPtrVarLen(base58_n_get_length, false)]);
export const base58_to_bytes = wrap('wally_base58_to_bytes', [T.String, T.Int32, T.DestPtrVarLen(base58_get_length, false)]);
export const base64_to_bytes = wrap('wally_base64_to_bytes', [T.String, T.Int32, T.DestPtrVarLen(base64_get_maximum_length, true)]);
export const map_get_item = wrap('wally_map_get_item', [T.OpaqueRef, T.Int32, T.DestPtrVarLen(map_get_item_length, false)]);
export const psbt_input_get_amount_rangeproof = wrap('wally_psbt_input_get_amount_rangeproof', [T.OpaqueRef, T.DestPtrVarLen(psbt_input_get_amount_rangeproof_len, false)]);
export const psbt_input_get_asset = wrap('wally_psbt_input_get_asset', [T.OpaqueRef, T.DestPtrVarLen(psbt_input_get_asset_len, false)]);
export const psbt_input_get_asset_surjectionproof = wrap('wally_psbt_input_get_asset_surjectionproof', [T.OpaqueRef, T.DestPtrVarLen(psbt_input_get_asset_surjectionproof_len, false)]);
export const psbt_input_get_inflation_keys_blinding_rangeproof = wrap('wally_psbt_input_get_inflation_keys_blinding_rangeproof', [T.OpaqueRef, T.DestPtrVarLen(psbt_input_get_inflation_keys_blinding_rangeproof_len, false)]);
export const psbt_input_get_inflation_keys_commitment = wrap('wally_psbt_input_get_inflation_keys_commitment', [T.OpaqueRef, T.DestPtrVarLen(C.ASSET_COMMITMENT_LEN)]);
export const psbt_input_get_inflation_keys_rangeproof = wrap('wally_psbt_input_get_inflation_keys_rangeproof', [T.OpaqueRef, T.DestPtrVarLen(psbt_input_get_inflation_keys_rangeproof_len, false)]);
export const psbt_input_get_issuance_amount_blinding_rangeproof = wrap('wally_psbt_input_get_issuance_amount_blinding_rangeproof', [T.OpaqueRef, T.DestPtrVarLen(psbt_input_get_issuance_amount_blinding_rangeproof_len, false)]);
export const psbt_input_get_issuance_amount_commitment = wrap('wally_psbt_input_get_issuance_amount_commitment', [T.OpaqueRef, T.DestPtrVarLen(C.ASSET_COMMITMENT_LEN)]);
export const psbt_input_get_issuance_amount_rangeproof = wrap('wally_psbt_input_get_issuance_amount_rangeproof', [T.OpaqueRef, T.DestPtrVarLen(psbt_input_get_issuance_amount_rangeproof_len, false)]);
export const psbt_input_get_issuance_asset_entropy = wrap('wally_psbt_input_get_issuance_asset_entropy', [T.OpaqueRef, T.DestPtrVarLen(C.BLINDING_FACTOR_LEN)]);
export const psbt_input_get_issuance_blinding_nonce = wrap('wally_psbt_input_get_issuance_blinding_nonce', [T.OpaqueRef, T.DestPtrVarLen(C.BLINDING_FACTOR_LEN)]);
export const psbt_input_get_pegin_claim_script = wrap('wally_psbt_input_get_pegin_claim_script', [T.OpaqueRef, T.DestPtrVarLen(psbt_input_get_pegin_claim_script_len, false)]);
export const psbt_input_get_pegin_genesis_blockhash = wrap('wally_psbt_input_get_pegin_genesis_blockhash', [T.OpaqueRef, T.DestPtrVarLen(psbt_input_get_pegin_genesis_blockhash_len, false)]);
export const psbt_input_get_pegin_txout_proof = wrap('wally_psbt_input_get_pegin_txout_proof', [T.OpaqueRef, T.DestPtrVarLen(psbt_input_get_pegin_txout_proof_len, false)]);
export const psbt_input_get_utxo_rangeproof = wrap('wally_psbt_input_get_utxo_rangeproof', [T.OpaqueRef, T.DestPtrVarLen(psbt_input_get_utxo_rangeproof_len, false)]);
export const psbt_output_get_asset = wrap('wally_psbt_output_get_asset', [T.OpaqueRef, T.DestPtrVarLen(psbt_output_get_asset_len, false)]);
export const psbt_output_get_asset_blinding_surjectionproof = wrap('wally_psbt_output_get_asset_blinding_surjectionproof', [T.OpaqueRef, T.DestPtrVarLen(psbt_output_get_asset_blinding_surjectionproof_len, false)]);
export const psbt_output_get_asset_commitment = wrap('wally_psbt_output_get_asset_commitment', [T.OpaqueRef, T.DestPtrVarLen(psbt_output_get_asset_commitment_len, false)]);
export const psbt_output_get_asset_surjectionproof = wrap('wally_psbt_output_get_asset_surjectionproof', [T.OpaqueRef, T.DestPtrVarLen(psbt_output_get_asset_surjectionproof_len, false)]);
export const psbt_output_get_blinding_public_key = wrap('wally_psbt_output_get_blinding_public_key', [T.OpaqueRef, T.DestPtrVarLen(psbt_output_get_blinding_public_key_len, false)]);
export const psbt_output_get_ecdh_public_key = wrap('wally_psbt_output_get_ecdh_public_key', [T.OpaqueRef, T.DestPtrVarLen(psbt_output_get_ecdh_public_key_len, false)]);
export const psbt_output_get_value_blinding_rangeproof = wrap('wally_psbt_output_get_value_blinding_rangeproof', [T.OpaqueRef, T.DestPtrVarLen(psbt_output_get_value_blinding_rangeproof_len, false)]);
export const psbt_output_get_value_commitment = wrap('wally_psbt_output_get_value_commitment', [T.OpaqueRef, T.DestPtrVarLen(psbt_output_get_value_commitment_len, false)]);
export const psbt_output_get_value_rangeproof = wrap('wally_psbt_output_get_value_rangeproof', [T.OpaqueRef, T.DestPtrVarLen(psbt_output_get_value_rangeproof_len, false)]);
export const psbt_to_bytes = wrap('wally_psbt_to_bytes', [T.OpaqueRef, T.Int32, T.DestPtrVarLen(psbt_get_length, false)]);
export const tx_to_bytes = wrap('wally_tx_to_bytes', [T.OpaqueRef, T.Int32, T.DestPtrVarLen(tx_get_length, false)]);
export const varbuff_to_bytes = wrap('wally_varbuff_to_bytes', [T.Bytes, T.DestPtrVarLen(varbuff_get_length, false)]);
export const varint_to_bytes = wrap('wally_varint_to_bytes', [T.Int64, T.DestPtrVarLen(varint_get_length, false)]);
// END AUTOGENERATED
