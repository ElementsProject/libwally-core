...
export const bip32_key_get_chain_code = wrap('bip32_key_get_chain_code', [T.OpaqueRef, T.DestPtrSized(T.Bytes, 100)]);
...
export const bip32_key_get_hash160 = wrap('bip32_key_get_hash160', [T.OpaqueRef, T.DestPtrSized(T.Bytes, 100)]);
export const bip32_key_get_parent160 = wrap('bip32_key_get_parent160', [T.OpaqueRef, T.DestPtrSized(T.Bytes, 100)]);
export const bip32_key_get_priv_key = wrap('bip32_key_get_priv_key', [T.OpaqueRef, T.DestPtrSized(T.Bytes, 100)]);
export const bip32_key_get_pub_key = wrap('bip32_key_get_pub_key', [T.OpaqueRef, T.DestPtrSized(T.Bytes, 100)]);
export const bip32_key_get_pub_key_tweak_sum = wrap('bip32_key_get_pub_key_tweak_sum', [T.OpaqueRef, T.DestPtrSized(T.Bytes, 100)]);
...
export const bip38_raw_to_private_key = wrap('bip38_raw_to_private_key', [T.Bytes, T.Bytes, T.Int32, T.DestPtrSized(T.Bytes, C.EC_PRIVATE_KEY_LEN)]);
export const bip38_to_private_key = wrap('bip38_to_private_key', [T.String, T.Bytes, T.Int32, T.DestPtrSized(T.Bytes, C.EC_PRIVATE_KEY_LEN)]);
...
export const bip39_mnemonic_to_seed = wrap('bip39_mnemonic_to_seed', [T.String, T.String, T.DestPtrVarLen(T.Bytes, C.BIP39_SEED_LEN_512)]);
...
export const ec_scalar_add_to = wrap('wally_ec_scalar_add_to', [T.DestPtrSized(T.Bytes, 100), T.Bytes]);
export const ec_scalar_multiply = wrap('wally_ec_scalar_multiply', [T.Bytes, T.Bytes, T.DestPtrSized(T.Bytes, C.EC_SCALAR_LEN)]);
export const ec_scalar_multiply_by = wrap('wally_ec_scalar_multiply_by', [T.DestPtrSized(T.Bytes, 100), T.Bytes]);
export const ec_scalar_subtract = wrap('wally_ec_scalar_subtract', [T.Bytes, T.Bytes, T.DestPtrSized(T.Bytes, C.EC_SCALAR_LEN)]);
export const ec_scalar_subtract_from = wrap('wally_ec_scalar_subtract_from', [T.DestPtrSized(T.Bytes, 100), T.Bytes]);
...
export const psbt_get_global_scalar = wrap('wally_psbt_get_global_scalar', [T.OpaqueRef, T.Int32, T.DestPtrSized(T.Bytes, 100)]);
...
export const psbt_get_input_previous_txid = wrap('wally_psbt_get_input_previous_txid', [T.OpaqueRef, T.Int32, T.DestPtrSized(T.Bytes, 100)]);
...
export const scrypt = wrap('wally_scrypt', [T.Bytes, T.Bytes, T.Int32, T.Int32, T.Int32, T.DestPtrSized(T.Bytes, 100)]);
...
export const tx_get_input_blinding_nonce = wrap('wally_tx_get_input_blinding_nonce', [T.OpaqueRef, T.Int32, T.DestPtrSized(T.Bytes, 100)]);
export const tx_get_input_entropy = wrap('wally_tx_get_input_entropy', [T.OpaqueRef, T.Int32, T.DestPtrSized(T.Bytes, 100)]);
...
export const tx_get_input_txhash = wrap('wally_tx_get_input_txhash', [T.OpaqueRef, T.Int32, T.DestPtrSized(T.Bytes, 100)]);
...
export const tx_get_output_asset = wrap('wally_tx_get_output_asset', [T.OpaqueRef, T.Int32, T.DestPtrSized(T.Bytes, 100)]);
export const tx_get_output_nonce = wrap('wally_tx_get_output_nonce', [T.OpaqueRef, T.Int32, T.DestPtrSized(T.Bytes, 100)]);
...
export const tx_input_get_blinding_nonce = wrap('wally_tx_input_get_blinding_nonce', [T.OpaqueRef, T.DestPtrSized(T.Bytes, 100)]);
export const tx_input_get_entropy = wrap('wally_tx_input_get_entropy', [T.OpaqueRef, T.DestPtrSized(T.Bytes, 100)]);
...
export const tx_input_get_txhash = wrap('wally_tx_input_get_txhash', [T.OpaqueRef, T.DestPtrSized(T.Bytes, 100)]);
...
export const psbt_input_get_inflation_keys_commitment = wrap('wally_psbt_input_get_inflation_keys_commitment', [T.OpaqueRef, T.DestPtrVarLen(T.Bytes, C.ASSET_COMMITMENT_LEN)]);
...
export const psbt_input_get_issuance_amount_commitment = wrap('wally_psbt_input_get_issuance_amount_commitment', [T.OpaqueRef, T.DestPtrVarLen(T.Bytes, C.ASSET_COMMITMENT_LEN)]);
...
export const psbt_input_get_issuance_asset_entropy = wrap('wally_psbt_input_get_issuance_asset_entropy', [T.OpaqueRef, T.DestPtrVarLen(T.Bytes, C.BLINDING_FACTOR_LEN)]);
export const psbt_input_get_issuance_blinding_nonce = wrap('wally_psbt_input_get_issuance_blinding_nonce', [T.OpaqueRef, T.DestPtrVarLen(T.Bytes, C.BLINDING_FACTOR_LEN)]);
