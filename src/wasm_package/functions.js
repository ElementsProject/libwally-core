...
export const psbt_input_get_amount_rangeproof = wrap('wally_psbt_input_get_amount_rangeproof', [T.OpaqueRef, T.DestPtrVarLen(100)]);
...
export const psbt_input_get_asset = wrap('wally_psbt_input_get_asset', [T.OpaqueRef, T.DestPtrVarLen(100)]);
export const psbt_input_get_asset_len = wrap('wally_psbt_input_get_asset_len', [T.OpaqueRef, T.DestPtr(T.Int32)]);
export const psbt_input_get_asset_surjectionproof = wrap('wally_psbt_input_get_asset_surjectionproof', [T.OpaqueRef, T.DestPtrVarLen(100)]);
