...
%apply(char *STRING, size_t LENGTH) { (const unsigned char* extra_input32, size_t extra_len) };
...
%apply(char *STRING, size_t LENGTH) { (const unsigned char* msg32, size_t msg_len) };
...
%apply(char *STRING, size_t LENGTH) { (const unsigned char* pubkey, size_t pubkey_len) };
%apply(char *STRING, size_t LENGTH) { (const unsigned char* pubkey33, size_t pubkey33_len) };
%apply(char *STRING, size_t LENGTH) { (const unsigned char* pubkey33, size_t pubkey_len) };
