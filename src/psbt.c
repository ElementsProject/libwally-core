...
#define PSBT_GLOBAL_SIGHASH_SINGLE_INPUTS 0x07
...
#define PSBT_IN_PROPRIETARY 0xFC
...
#define PSBT_OUT_TAP_LEAF_SCRIPT 0x06
#define PSBT_OUT_TAP_BIP32_DERIVATION 0x07
#define PSBT_OUT_PROPRIETARY 0xFC
...
#define PSET_IN_ISSUANCE_INFLATION_KEYS 0x10
