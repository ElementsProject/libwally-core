...
for f in (
    ...
    ('wally_psbt_clear_input_value', c_int, [POINTER(wally_psbt), c_size_t]),
    ...
    ('wally_psbt_get_input_abf', c_int, [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t, c_size_t_p]),
    ('wally_psbt_get_input_abf_len', c_int, [POINTER(wally_psbt), c_size_t, c_size_t_p]),
    ...
    ('wally_psbt_get_input_claim_script', c_int, [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t, c_size_t_p]),
    ('wally_psbt_get_input_claim_script_len', c_int, [POINTER(wally_psbt), c_size_t, c_size_t_p]),
    ...
    ('wally_psbt_get_input_genesis_blockhash', c_int, [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t, c_size_t_p]),
    ('wally_psbt_get_input_genesis_blockhash_len', c_int, [POINTER(wally_psbt), c_size_t, c_size_t_p]),
    ...
    ('wally_psbt_get_input_pegin_tx_alloc', c_int, [POINTER(wally_psbt), c_size_t, POINTER(POINTER(wally_tx))]),
    ...
    ('wally_psbt_get_input_txoutproof', c_int, [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t, c_size_t_p]),
    ('wally_psbt_get_input_txoutproof_len', c_int, [POINTER(wally_psbt), c_size_t, c_size_t_p]),
    ...
    ('wally_psbt_get_input_value', c_int, [POINTER(wally_psbt), c_size_t, c_uint64_p]),
    ('wally_psbt_get_input_vbf', c_int, [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t, c_size_t_p]),
    ('wally_psbt_get_input_vbf_len', c_int, [POINTER(wally_psbt), c_size_t, c_size_t_p]),
    ...
    ('wally_psbt_get_output_abf', c_int, [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t, c_size_t_p]),
    ('wally_psbt_get_output_abf_len', c_int, [POINTER(wally_psbt), c_size_t, c_size_t_p]),
    ...
    ('wally_psbt_get_output_blinding_pubkey', c_int, [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t, c_size_t_p]),
    ('wally_psbt_get_output_blinding_pubkey_len', c_int, [POINTER(wally_psbt), c_size_t, c_size_t_p]),
    ...
    ('wally_psbt_get_output_nonce', c_int, [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t, c_size_t_p]),
    ('wally_psbt_get_output_nonce_len', c_int, [POINTER(wally_psbt), c_size_t, c_size_t_p]),
    ('wally_psbt_get_output_rangeproof', c_int, [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t, c_size_t_p]),
    ('wally_psbt_get_output_rangeproof_len', c_int, [POINTER(wally_psbt), c_size_t, c_size_t_p]),
    ...
    ('wally_psbt_get_output_surjectionproof', c_int, [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t, c_size_t_p]),
    ('wally_psbt_get_output_surjectionproof_len', c_int, [POINTER(wally_psbt), c_size_t, c_size_t_p]),
    ...
    ('wally_psbt_get_output_vbf', c_int, [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t, c_size_t_p]),
    ('wally_psbt_get_output_vbf_len', c_int, [POINTER(wally_psbt), c_size_t, c_size_t_p]),
    ...
    ('wally_psbt_has_input_value', c_int, [POINTER(wally_psbt), c_size_t, c_size_t_p]),
    ('wally_psbt_has_output_amount', c_int, [POINTER(wally_psbt), c_size_t, c_size_t_p]),
    ('wally_psbt_set_input_abf', c_int, [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t]),
    ('wally_psbt_set_input_asset', c_int, [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t]),
    ('wally_psbt_set_input_claim_script', c_int, [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t]),
    ...
    ('wally_psbt_set_input_genesis_blockhash', c_int, [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t]),
    ...
    ('wally_psbt_set_input_pegin_tx', c_int, [POINTER(wally_psbt), c_size_t, POINTER(wally_tx)]),
    ...
    ('wally_psbt_set_input_txoutproof', c_int, [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t]),
    ...
    ('wally_psbt_set_input_value', c_int, [POINTER(wally_psbt), c_size_t, c_uint64]),
    ('wally_psbt_set_input_vbf', c_int, [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t]),
    ...
    ('wally_psbt_set_output_abf', c_int, [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t]),
    ...
    ('wally_psbt_set_output_blinding_pubkey', c_int, [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t]),
    ('wally_psbt_set_output_keypaths', c_int, [POINTER(wally_psbt), c_size_t, POINTER(wally_map)]),
    ('wally_psbt_set_output_nonce', c_int, [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t]),
    ('wally_psbt_set_output_rangeproof', c_int, [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t]),
    ...
    ('wally_psbt_set_output_surjectionproof', c_int, [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t]),
    ...
    ('wally_psbt_set_output_vbf', c_int, [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t]),
