...
for f in (
    ...
    ('wally_descriptor_to_addresses', c_int, [c_char_p, POINTER(wally_map), c_uint32, c_uint32, c_uint32, POINTER(c_char_p), c_size_t]),
    ('wally_descriptor_to_scriptpubkey', c_int, [c_void_p, c_uint32, c_uint32, c_uint32, c_uint32, c_uint32, c_void_p, c_size_t, c_size_t_p]),
    ('wally_descriptor_to_scriptpubkey_len', c_int, [c_void_p, c_uint32, c_uint32, c_uint32, c_uint32, c_uint32, c_size_t_p]),
    ('wally_descriptor_to_scriptpubkey_maximum_length', c_int, [c_void_p, c_uint32, c_size_t_p]),
