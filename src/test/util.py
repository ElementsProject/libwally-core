...
class wally_psbt_input(Structure):
    _fields_ = [('utxo', POINTER(wally_tx)),
                ...
                ('issuance_amount_commitment', c_void_p),
                ('issuance_amount_commitment_len', c_ulong),
                ('issuance_amount_rangeproof', c_void_p),
                ('issuance_amount_rangeproof_len', c_ulong),
                ('inflation_keys_rangeproof', c_void_p),
                ('inflation_keys_rangeproof_len', c_ulong),
                ('pegin_value', c_uint64),
                ('has_pegin_value', c_uint32),
...
for f in (
    ...
    ('wally_psbt_input_has_issuance_amount', c_int, [POINTER(wally_psbt_input), c_ulong_p]),
    ...
    ('wally_psbt_output_set_value', c_int, [POINTER(wally_psbt_output), c_uint64]),
