...
for f in (
    ...
    ('wally_descriptor_canonicalize', c_int, [c_char_p, POINTER(wally_map), c_uint32, c_char_p_p]),
    ('wally_descriptor_free', c_int, [c_void_p]),
    ('wally_descriptor_get_checksum', c_int, [c_char_p, POINTER(wally_map), c_uint32, c_char_p_p]),
