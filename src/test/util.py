...
bip38_funcs = [('base58_from_bytes', None, [c_void_p, c_ulong, c_uint, POINTER(c_char_p)]),
               ...
               ('scrypt', c_int, [c_void_p, c_ulong, c_void_p, c_ulong,
                                  c_uint, c_uint, c_uint, c_void_p, c_ulong])]
...
pbkdf2_funcs = [('pbkdf2_hmac_sha256', c_int, [c_void_p, c_ulong, c_void_p, c_ulong, c_ulong, c_void_p, c_ulong]),
                ('pbkdf2_hmac_sha512', c_int, [c_void_p, c_ulong, c_void_p, c_ulong, c_ulong, c_void_p, c_ulong])]
