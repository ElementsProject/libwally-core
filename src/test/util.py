...
for f in (
    ...
    ('wally_descriptor_create_checksum', c_int, [c_char_p, c_char_p_p, c_char_p_p, c_size_t, c_uint32, c_char_p_p]),
    ('wally_descriptor_parse_miniscript', c_int, [c_char_p, c_char_p_p, c_char_p_p, c_size_t, c_uint32, c_uint32, c_void_p, c_size_t, c_size_t_p]),
    ('wally_descriptor_to_address', c_int, [c_char_p, c_char_p_p, c_char_p_p, c_size_t, c_uint32, c_uint32, c_uint32, c_char_p_p]),
    ('wally_descriptor_to_addresses', c_int, [c_char_p, c_char_p_p, c_char_p_p, c_size_t, c_uint32, c_uint32, c_uint32, c_uint32, POINTER(wally_descriptor_addresses)]),
    ('wally_descriptor_to_scriptpubkey', c_int, [c_char_p, c_char_p_p, c_char_p_p, c_size_t, c_uint32, c_uint32, c_uint32, c_uint32, c_uint32, c_void_p, c_size_t, c_size_t_p]),
