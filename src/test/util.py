...
class wally_psbt_input(Structure):
    _fields_ = [('utxo', POINTER(wally_tx)),
                ...
                ('unknowns', wally_map),
                ('sighash', c_ulong),
                ('issuance_value', c_uint64),
                ('has_issuance_value', c_ulong),
                ('issuance_amount', c_void_p),
                ('issuance_amount_len', c_ulong),
                ('issuance_amount_rangeproof', c_void_p),
                ('issuance_amount_rangeproof_len', c_ulong),
                ('inflation_keys_rangeproof', c_void_p),
                ('inflation_keys_rangeproof_len', c_ulong),
                ('pegin_value', c_uint64),
                ('has_pegin_value', c_ulong),
                ('pegin_tx', POINTER(wally_tx)),
                ('pegin_witness', POINTER(wally_tx_witness_stack)),
                ('pegin_txoutproof', c_void_p),
                ('pegin_txoutproof_len', c_ulong),
...
for f in (
    ...
    ('wally_psbt_get_global_scalar_offset', c_int, [POINTER(wally_psbt), c_void_p, c_ulong, c_ulong_p]),
    ...
    ('wally_psbt_input_clear_issuance_value', c_int, [POINTER(wally_psbt_input)]),
    ('wally_psbt_input_clear_pegin_value', c_int, [POINTER(wally_psbt_input)]),
    ...
    ('wally_psbt_input_has_issuance_value', c_int, [POINTER(wally_psbt_input), c_ulong_p]),
    ('wally_psbt_input_has_pegin_value', c_int, [POINTER(wally_psbt_input), c_ulong_p]),
    ...
    ('wally_psbt_input_set_issuance_amount', c_int, [POINTER(wally_psbt_input), c_void_p, c_ulong]),
    ('wally_psbt_input_set_issuance_amount_rangeproof', c_int, [POINTER(wally_psbt_input), c_void_p, c_ulong]),
    ('wally_psbt_input_set_issuance_value', c_int, [POINTER(wally_psbt_input), c_uint64]),
    ...
    ('wally_psbt_input_set_pegin_txoutproof', c_int, [POINTER(wally_psbt_input), c_void_p, c_ulong]),
    ...
    ('wally_psbt_set_global_scalar_offset', c_int, [POINTER(wally_psbt), c_void_p, c_ulong]),
