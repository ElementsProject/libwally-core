...
for f in (
    ...
    ('wally_psbt_blind', c_int, [POINTER(wally_psbt), POINTER(wally_map), POINTER(wally_map), POINTER(wally_map), POINTER(wally_map), c_void_p, c_size_t, c_uint32, POINTER(wally_map)]),
    ('wally_psbt_blind_alloc', c_int, [POINTER(wally_psbt), POINTER(wally_map), POINTER(wally_map), POINTER(wally_map), POINTER(wally_map), c_void_p, c_size_t, c_uint32, POINTER(POINTER(wally_map))]),
