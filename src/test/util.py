...
class wally_keypath_item(Structure):
    _fields_ = [('path', POINTER(c_ulong)),
                ('path_len', c_ulong),
                ('fingerprint', c_ubyte * 4),
                ('pubkey', c_ubyte * 65)]

class wally_keypath_map(Structure):
    _fields_ = [('items', POINTER(wally_keypath_item)),
                ('num_items', c_ulong),
                ('items_allocation_len', c_ulong)]
...
class wally_unknowns_item(Structure):
    _fields_ = [('key', c_void_p),
                ('key_len', c_ulong),
                ('value', c_void_p),
                ('value_len', c_ulong)]

class wally_unknowns_map(Structure):
    _fields_ = [('items', POINTER(wally_unknowns_item)),
                ('num_items', c_ulong),
                ('items_allocation_len', c_ulong)]
...
class wally_psbt_input(Structure):
    _fields_ = [('non_witness_utxo', POINTER(wally_tx)),
                ...
                ('unknowns', POINTER(wally_unknowns_map)),
...
for f in (
    ...
    ('wally_keypath_map_add', c_int, [POINTER(wally_keypath_map), c_void_p, c_ulong, c_void_p, c_ulong, c_uint_p, c_ulong]),
    ...
    ('wally_psbt_elements_init_alloc', c_int, [c_ulong, c_ulong, c_ulong, POINTER(POINTER(wally_psbt))]),
    ('wally_psbt_elements_input_clear_value', c_int, [POINTER(wally_psbt_input)]),
    ('wally_psbt_elements_input_init_alloc', c_int, [POINTER(wally_tx), POINTER(wally_tx_output), c_void_p, c_ulong, c_void_p, c_ulong, c_void_p, c_ulong, POINTER(wally_tx_witness_stack), POINTER(wally_keypath_map), POINTER(wally_partial_sigs_map), POINTER(wally_unknowns_map), c_uint, c_uint64, c_uint, c_void_p, c_ulong, c_void_p, c_ulong, c_void_p, c_ulong, POINTER(wally_tx), c_void_p, c_ulong, c_void_p, c_ulong, c_void_p, c_ulong, POINTER(POINTER(wally_psbt_input))]),
    ('wally_psbt_elements_input_set_asset_blinder', c_int, [POINTER(wally_psbt_input), c_void_p, c_ulong]),
    ('wally_psbt_elements_input_set_asset', c_int, [POINTER(wally_psbt_input), c_void_p, c_ulong]),
    ('wally_psbt_elements_input_set_claim_script', c_int, [POINTER(wally_psbt_input), c_void_p, c_ulong]),
    ('wally_psbt_elements_input_set_genesis_hash', c_int, [POINTER(wally_psbt_input), c_void_p, c_ulong]),
    ('wally_psbt_elements_input_set_peg_in_tx', c_int, [POINTER(wally_psbt_input), POINTER(wally_tx)]),
    ('wally_psbt_elements_input_set_txout_proof', c_int, [POINTER(wally_psbt_input), c_void_p, c_ulong]),
    ('wally_psbt_elements_input_set_value_blinder', c_int, [POINTER(wally_psbt_input), c_void_p, c_ulong]),
    ('wally_psbt_elements_input_set_value', c_int, [POINTER(wally_psbt_input), c_uint64]),
    ('wally_psbt_elements_output_init_alloc', c_int, [c_void_p, c_ulong, c_void_p, c_ulong, POINTER(wally_keypath_map), POINTER(wally_unknowns_map), c_void_p, c_ulong, c_void_p, c_ulong, c_void_p, c_ulong, c_void_p, c_ulong, c_void_p, c_ulong, c_void_p, c_ulong, c_void_p, c_ulong, c_void_p, c_ulong, POINTER(POINTER(wally_psbt_output))]),
    ('wally_psbt_elements_output_set_asset_blinder', c_int, [POINTER(wally_psbt_output), c_void_p, c_ulong]),
    ('wally_psbt_elements_output_set_asset_commitment', c_int, [POINTER(wally_psbt_output), c_void_p, c_ulong]),
    ('wally_psbt_elements_output_set_blinding_pubkey', c_int, [POINTER(wally_psbt_output), c_void_p, c_ulong]),
    ('wally_psbt_elements_output_set_nonce_commitment', c_int, [POINTER(wally_psbt_output), c_void_p, c_ulong]),
    ('wally_psbt_elements_output_set_range_proof', c_int, [POINTER(wally_psbt_output), c_void_p, c_ulong]),
    ('wally_psbt_elements_output_set_surjection_proof', c_int, [POINTER(wally_psbt_output), c_void_p, c_ulong]),
    ('wally_psbt_elements_output_set_value_blinder', c_int, [POINTER(wally_psbt_output), c_void_p, c_ulong]),
    ('wally_psbt_elements_output_set_value_commitment', c_int, [POINTER(wally_psbt_output), c_void_p, c_ulong]),
    ...
    ('wally_psbt_input_init_alloc', c_int, [POINTER(wally_tx), POINTER(wally_tx_output), c_void_p, c_ulong, c_void_p, c_ulong, c_void_p, c_ulong, POINTER(wally_tx_witness_stack), POINTER(wally_keypath_map), POINTER(wally_partial_sigs_map), POINTER(wally_unknowns_map), c_uint, POINTER(POINTER(wally_psbt_input))]),
    ('wally_psbt_input_set_final_script_sig', c_int, [POINTER(wally_psbt_input), c_void_p, c_ulong]),
    ...
    ('wally_psbt_input_set_unknowns', c_int, [POINTER(wally_psbt_input), POINTER(wally_unknowns_map)]),
    ...
    ('wally_psbt_output_init_alloc', c_int, [c_void_p, c_ulong, c_void_p, c_ulong, POINTER(wally_keypath_map), POINTER(wally_unknowns_map), POINTER(POINTER(wally_psbt_output))]),
    ('wally_psbt_output_set_keypaths', c_int, [POINTER(wally_psbt_output), POINTER(wally_keypath_map)]),
    ...
    ('wally_unknowns_map_add', c_int, [POINTER(wally_unknowns_map), c_void_p, c_ulong, c_void_p, c_ulong]),
    ('wally_unknowns_map_find', c_int, [POINTER(wally_unknowns_map), c_void_p, c_ulong, c_ulong_p]),
    ('wally_unknowns_map_free', c_int, [POINTER(wally_unknowns_map)]),
    ('wally_unknowns_map_init_alloc', c_int, [c_ulong, POINTER(POINTER(wally_unknowns_map))]),
