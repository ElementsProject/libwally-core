...
for f in (
    ...
    ('wally_psbt_input_set_asset_blinder', c_int, [POINTER(wally_psbt_input), c_void_p, c_ulong]),
    ...
    ('wally_psbt_input_set_genesis_hash', c_int, [POINTER(wally_psbt_input), c_void_p, c_ulong]),
    ('wally_psbt_input_set_peg_in_tx', c_int, [POINTER(wally_psbt_input), POINTER(wally_tx)]),
    ('wally_psbt_input_set_txout_proof', c_int, [POINTER(wally_psbt_input), c_void_p, c_ulong]),
    ('wally_psbt_input_set_value_blinder', c_int, [POINTER(wally_psbt_input), c_void_p, c_ulong]),
    ('wally_psbt_input_set_value', c_int, [POINTER(wally_psbt_input), c_uint64]),
    ('wally_psbt_output_set_asset_blinder', c_int, [POINTER(wally_psbt_output), c_void_p, c_ulong]),
    ...
    ('wally_psbt_output_set_nonce_commitment', c_int, [POINTER(wally_psbt_output), c_void_p, c_ulong]),
    ('wally_psbt_output_set_range_proof', c_int, [POINTER(wally_psbt_output), c_void_p, c_ulong]),
    ('wally_psbt_output_set_surjection_proof', c_int, [POINTER(wally_psbt_output), c_void_p, c_ulong]),
    ('wally_psbt_output_set_value_blinder', c_int, [POINTER(wally_psbt_output), c_void_p, c_ulong]),
